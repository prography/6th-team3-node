# Migration `20200626235211`

This migration has been generated by boorim98 at 6/26/2020, 11:52:11 PM.
...
`created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ,`id` int NOT NULL  AUTO_INCREMENT,`name` varchar(191)   ,`reservation_id` int NOT NULL ,`updated_at` datetime(3)   ,
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
